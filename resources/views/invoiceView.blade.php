...
<div class="container p-2">
        ...
        <div class="flex-1">
            <div class="font-bold mb-2">
                ...
                <span id="totalInvoice"
                    class="ring-2 ring-offset-2 text-yellow-400 ring-offset-blue-300 hover:ring-offset-blue-500 pt-1">
                    {{ sizeof($invoices) }}
                </span>
            </div>
            <div class="font-bold mt-2">
                ...
                <span id="totalRevenue"
                    class="ring-2 ring-offset-2 text-green-400 ring-offset-blue-300 hover:ring-offset-blue-500 pt-1">
    ...
    <div id="invoice-view-block"
        class="relative flex min-h-screen flex-row flex-wrap justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        <?php
        ...
        <div
            ...
            <div class="relative z-10 mx-auto max-w-md">
                ...
                <div class="pt-5 text-base font-semibold leading-7">
                    <p>
                        <button onclick="GetViewDetail('{{ $invoice->invoiceId }}')" type="button"
                            id="viewProductButton" data-modal-toggle="viewInvoiceModel"
                        ...
                        <button type="button" onclick="Delete('{{ $invoice->invoiceId }}')"
                                class="flex items-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">xóa
                                </button>
                    </p>
                </div>
            </div>
...
<div id="viewInvoiceModel" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow  sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="viewInvoiceModel">
